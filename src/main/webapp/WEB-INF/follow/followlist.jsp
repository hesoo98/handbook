        ...
        <c:forEach var="dto" items="${list }">
            <div class="userbox">
                ...
                <c:if test="${dto.user_photo!=null}">
                    <div class="up">
                        <a href="/user/mypage?user_num=${dto.to_user }"><img src="/photo/${dto.user_photo }"
                                                                             class="userphoto"></a>
                    </div>
                </c:if>
                ...
                <c:if test="${from_user==sessionScope.user_num}">
                    <div class="btndiv">
                        <button type="button" class="addbtn" fing_num= ${dto.fing_num }><img src="../image/add.png">
                        </button>
                        ...
                        <div class="friendmenu" id="${dto.fing_num }">
                            ...
                            <div class="detailbtn">
                                ...
                                <c:if test="${dto.bookmarkcheck!=1 }">
                                    <button type="button" class="insbookbtn" bfriend_num="${dto.to_user }"><b><span
                                ...
                                <c:if test="${dto.bookmarkcheck==1 }">
                                    <button type="button" class="delbookbtn" bfriend_num="${dto.to_user }"><b><span
                                            style="font-size: 15pt;">
                            ...
                            <div class="detailbtn">
                                <button type="button" class="fldelete" to_user= ${dto.to_user }><b><span
                                        style="font-size: 15pt; margin-left: 4px;">
