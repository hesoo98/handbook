...
<script type="text/javascript">
    $(function () {
        ...
        $(".followsearchbox").keyup(function (e) {
            if (e.keyCode == 13) {
                location.href = "recommendlist?from_user="+${sessionScope.user_num}+
                "&searchword=" + $(".followsearchbox").val(); //sessionScope.user_num 로그인한 사람
            }
        });
    });
            ...
            <div class="userbox">
                <div class="upunbox">
                    <c:if test="${dto.user_photo!=null}">
                        <div class="up">
                            <a href="/user/mypage?user_num=${dto.user_num }"><img src="/photo/${dto.user_photo }"
                                                                                  class="userphoto"></a>
                        </div>
                    </c:if>
                    ...
                    <c:if test="${dto.user_photo==null}">
                        <div class="up">
                            <a href="/user/mypage?user_num=${dto.user_num }"><img src="../image/noimg.png"
                                                                                  class="userphoto"></a>
                        </div>
                    </c:if>
                    <div class="un">
