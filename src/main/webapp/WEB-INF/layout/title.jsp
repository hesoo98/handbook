...
<div class="titlecontainer">
    ...
    <div style="width: 280px;" class="titlelogo"><a href="${root }/"><img src="../image/handbooklogo.png"
    ...
    <c:if test="${sessionScope.loginok != null }">
            ...
            <div style="width: 100%;background-color: white; display: inline-flex; align-items: center;">
                ...
                <div style="background-color: #F0F2F5; border-radius: 60px; display: inline-flex; align-items: center; padding-left: 2%">
                    ...
                    <input type="text" name="searchword" class="searchpost"
                           style="width:500px; border: none; background: none; outline: none; font-size: 15pt; padding: 10px;"
                           placeholder="Handbook 검색">
                </div>
            </div>
        ...
        <div style="display: inline-flex; overflow: hidden; align-items: center; justify-content: center; width: 280px;">
            <c:if test="${sessionScope.loginok!=null }">
                <div class="titlecircle tti">
                    <button type="button" onclick="location.href='/login/logoutprocess'" class="btntti"><img alt=""
                                                                                                             src="../image/logout.png"
                                                                                                             style="width: 23px; margin-bottom: 5px;">
                    </button>
                </div>
            </c:if>

            <div class="titlecircle tti"><span class="glyphicon glyphicon-th titlemenubar"
                                               style="font-size: 15pt; color: black;"></span></div>
            <div class="titlecircle tti ttimsg"><span style="font-size: 15pt; color: black;"><i
                    class="fa-regular fa-comment-dots"></i></span></div>
            <!-- 메시지 알림 개수 표시 시작 -->
            <div class="msgalarmcircle"></div>
            <!-- 메시지 알림 개수 표시 끝 -->

            <div class="titlecircle tti ttialarm"><span style="font-size: 15pt; color: black;"><i
                    class="fa-solid fa-bell"></i></span></div>
            <!-- 메시지 알림 개수 표시 시작 -->
            <div class="allalarmcircle"></div>
            <!-- 메시지 알림 개수 표시 끝 -->

            <c:if test="${sessionScope.user_photo==null }">
                <div class="tti ttiuphoto"><a href="/user/mypage?user_num=${sessionScope.user_num }"><img
                        src="../image/noimg.png" alt=""></a></div>
            </c:if>

            <c:if test="${sessionScope.user_photo!=null }">
                <div class="tti ttiuphoto"><a href="/user/mypage?user_num=${sessionScope.user_num }"><img
                        src="../photo/${sessionScope.user_photo }" alt=""></a></div>
            </c:if>
        </div>
    </c:if>
...
<div class="stitle">
    <div class="titlemenu allmenu" style="height:300px; width: 200px; border-radius: 10px;">
        <div class="subtitlemenu">
            ...
            <div class="titledetail"><a data-toggle="modal" data-target="#contentwrite">
                <div class="titlecircle"><span class="glyphicon glyphicon-check"></span></div>
                <span>게시물 작성</span></a></div>
            <div class="titledetail"><a href="${root }/following/recommendlist?from_user=${sessionScope.user_num}">
                <div class="titlecircle"><span class="glyphicon glyphicon-search"></span></div>
                <span>친구 찾기</span></a></div>
            <div class="titledetail"><a href="${root }/post/bookmarktimeline">
                <div class="titlecircle"><span class="glyphicon glyphicon-star"></span></div>
                <span>즐겨 찾기</span></a></div>
            <div class="titledetail" id="deleteuser"><a>
                <div class="titlecircle"><i class="fa-solid fa-user-xmark"></i></div>
                <span>회원탈퇴</span></a></div>
        </div>
