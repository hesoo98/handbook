                    ...
                    <div class="allcomment" style="margin-left: ${dto.comment_level*50}px;">
                        ...
                        <c:if test="${dto.post_user_num.equals(sessionScope.user_num) or dto.user_num.equals(sessionScope.user_num) }">
                            <div style="height: 0; width: 450px; position: relative; left: -30px; top: 30px;">
                                <img src="../image/add.png" class="ulimg" style="width: 20px; float: right;"
                                ...
                                <div class="comment" id="commentmod${dto.comment_num }"
                                     style="display: none; width: 447px; position: relative; left: 31px; bottom: 31px;">
                                    <img src="/photo/${dto.user_photo }" class="profile">
                                    <b class="user_name">${dto.user_name }</b>
                                    <br>
                                    <input type="text" class="inputmod" style="width: 200px;"
                                           comment_num="${dto.comment_num }" value="${dto.comment_content }">
                                </div>
                            </div>
                        </c:if>
                        ...
                        <div class="cmlike">
                            <c:if test="${dto.like_check==0 }">
                                <span class="glyphicon glyphicon-heart-empty nolike" style="color: red;"
                                      comment_num="${dto.comment_num }">${dto.like_count }</span>
                            </c:if>
                            <c:if test="${dto.like_check!=0 }">
                                <span class="glyphicon glyphicon-heart yeslike" style="color: red;"
                                      comment_num="${dto.comment_num }">${dto.like_count }</span>
                            </c:if>
                        ...
                        <form method="post" class="form-inline" id="comment${dto.comment_num }" style="display: none;">
                            <div id="commentaddform">
                                ...
                                <input hidden="hidden"/>
                                <input type="text" class="input" name="comment_content" placeholder="답글을 입력하세요"
                                       id="input${dto.comment_num }">
                                <button type="button" class="btn btn-info cminsert" comment_num="${dto.comment_num }"
                                        post_num="9" style="margin-right: 20px;">답글입력
                                </button>
                            </div>
                        </form>
                    </div>
                ...
                <form method="post" class="form-inline" id="form">
                    ...
                    <div id="commentaddform">
                        ...
                        <input type="text" class="mominput" name="comment_content" placeholder="댓글을 입력하세요"
                               id="commentinput">
                        <button type="button" id="insertbtn" class="btn btn-info" style="margin-right: 20px;">입력
                        </button>
                    </div>
                </form>
            </div>
